...
import math
from fbref_scraper import get_team_corners
...
def predict_fixture(enriched: dict) -> dict | None:
    ...
    # Pull corners from FBRef cache
    home_corners_data = get_team_corners(enriched["home_team"], league) or {}
    away_corners_data = get_team_corners(enriched["away_team"], league) or {}
...
if __name__ == "__main__":
    ...
    # Patch get_team_corners to return mock FBRef data for this test
    import fbref_scraper
    fbref_scraper.get_team_corners = lambda team, league: {
        "corners_avg":          5.8 if "Arsenal" in team else 4.2,
        "corners_home_avg":     6.5 if "Arsenal" in team else 4.8,
        "corners_away_avg":     5.1 if "Arsenal" in team else 3.6,
        "corners_conceded_avg": 4.0 if "Arsenal" in team else 5.2,
    }
